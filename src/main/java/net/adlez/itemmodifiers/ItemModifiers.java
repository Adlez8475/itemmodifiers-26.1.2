...
public class ItemModifiers {
    ...
    public ItemModifiers(IEventBus modEventBus, ModContainer modContainer) {
        // Register the commonSetup method for modloading
        modEventBus.addListener(this::commonSetup);
        // Register ourselves for server and other game events we are interested in.
        // Note that this is necessary if and only if we want *this* class (ItemModifiers) to respond directly to events.
    ...
    private void commonSetup(FMLCommonSetupEvent event) {
        ...
        LOGGER.info("Item Modifiers : loaded!");
    }
